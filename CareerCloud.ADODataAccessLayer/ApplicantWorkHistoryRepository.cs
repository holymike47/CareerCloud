...
{
    public class ApplicantWorkHistoryRepository : BaseDataRepository, IDataRepository<ApplicantWorkHistoryPoco>
    {
        public void Add(params ApplicantWorkHistoryPoco[] items)
        {
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                ...
                {
                    command.CommandText = @"INSERT INTO [dbo].[Applicant_Work_History](Id,Applicant,Company_Name,
                                        Country_Code,Location,Job_Title,Job_Description,Start_Month,Start_Year,
                                        End_Month,End_Year)VALUES(@Id,@Applicant,@Company_Name,
                                        @Country_Code,@Location,@Job_Title,@Job_Description,@Start_Month,@Start_Year,
                                        @End_Month,@End_Year)";
        ...
        public IList<ApplicantWorkHistoryPoco> GetAll(params Expression<Func<ApplicantWorkHistoryPoco, object>>[] navigationProperties)
        {
            ...
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                string sql = @"SELECT Id,Applicant,Company_Name,
                                        Country_Code,Location,Job_Title,Job_Description,Start_Month,Start_Year,
                                        End_Month,End_Year,Time_Stamp FROM [dbo].[Applicant_Work_History]";
        ...
        public void Update(params ApplicantWorkHistoryPoco[] items)
        {
            using (SqlConnection connection = new SqlConnection(ConnectionString))
            {
                ...
                foreach (ApplicantWorkHistoryPoco poco in items)
                {
                    command.CommandText = @"UPDATE [dbo].[Applicant_Work_History] SET Id=@Id,Applicant=@Applicant,
