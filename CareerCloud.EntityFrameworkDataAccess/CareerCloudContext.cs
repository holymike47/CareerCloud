...
namespace CareerCloud.EntityFrameworkDataAccess
{
    public class CareerCloudContext:DbContext
    {
        ...
        public virtual DbSet<SecurityLoginPoco> SecurityLogin { get; set; }
        public virtual DbSet<SecurityLoginsLogPoco> SecurityLoginsLog { get; set; }
        public virtual DbSet<SecurityLoginsRolePoco> SecurityLoginsRole { get; set; }
        public virtual DbSet<SecurityRolePoco> SecurityRole { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SecurityLoginPoco>()
                .HasMany(m => m.SecurityLoginsLogs)
                .WithRequired(r => r.SecurityLogin)
                .HasForeignKey(k => k.Login);


            modelBuilder.Entity<SecurityLoginPoco>()
                .HasMany(m => m.SecurityLoginsRoles)
                .WithRequired(r => r.SecurityLogin)
                .HasForeignKey(k => k.Login);
